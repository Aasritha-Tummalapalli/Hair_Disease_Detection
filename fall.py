...
def load_model():
    return tf.keras.models.load_model(
        r"C:\Users\DELL\Downloads\Hair_Diease_Detection\MobileNetV2_hair_model.h5",
        compile=False
    )
...
@st.cache_data
def load_products():
    df = pd.read_csv(r"C:\Users\DELL\Downloads\Hair_Diease_Detection\products.csv")
...
@st.cache_data
def load_remedies():
    df = pd.read_csv(r"C:\Users\DELL\Downloads\Hair_Diease_Detection\ayurveda_remedies.csv")
    df.columns = df.columns.str.strip().str.lower()
    return df
